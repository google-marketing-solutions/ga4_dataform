...
const SOURCE_PROJECT = "cymbaum" /* specify a value here only in case your source data sits in a project other than the default defined in workflow_settings.yaml defaultDatabase variable. You would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
const SOURCE_DATASET = "vivo_temp_copy"; /* the database containing the GA4 BigQuery exports */
...
const SEEDS_DATASET = "ga4_dataform_nm_git_seed"; /* the database containing the GA4 BigQuery data mapping seeds such as source categories */
const STAGING_DATASET = "ga4_dataform_nm_git_staging";
const INTERMEDIATE_DATASET = "ga4_dataform_nm_git_intermediate";
const OUTPUT_DATASET = "final_dataform_nm_git_output";
