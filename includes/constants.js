...
const SOURCE_PROJECT = "marriott-propensity-model" /* specify a value here only in case your source data sits in a project other than the default defined in workflow_settings.yaml defaultDatabase variable. You would need to grant the Dataform service account BigQuery Data Viewer and BigQuery Job User access to the dataset. */
...
const SEEDS_DATASET = "marriott_data"; /* the database containing the GA4 BigQuery data mapping seeds such as source categories */
